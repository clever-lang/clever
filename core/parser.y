...
fully_qualified_call:
	...
	|	fully_qualified_name ':' TYPE '.' IDENT '(' call_args ')' { $1->append(':', $3); $<mcall>$ = new ast::MethodCall(new ast::Type($1->getName(), yyloc), $5, $7, yyloc); clever_delref($1); } mcall_chain { $<node>$ = $<node>10; }
;
